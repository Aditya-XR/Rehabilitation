...
export function AuthPage() {
  const { login, signup, googleLogin, authError, authNotice, clearAuthMessages } = useAuth()
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auth state and messaging are handled in the provider.
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md relative shadow-lg border-border/50">
        <CardHeader className="text-center space-y-4 pb-2">
          ...
          <div>
            <CardTitle className="text-2xl font-serif tracking-wide text-foreground">
              Serenity Center
            </CardTitle>
