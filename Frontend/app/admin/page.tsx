...
type AdminDashboardView = "slots" | "bookings" | "content"

const adminNavItems: PortalNavItem<AdminDashboardView>[] = [
...
function AdminDashboardPage() {
  const [activeView, setActiveView] = useState<AdminDashboardView>("slots")
